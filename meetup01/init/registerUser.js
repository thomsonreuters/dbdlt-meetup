...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    fabric_ca_client = new Fabric_CA_Client(currentCA, null , '', crypto_suite);
    ...
    return fabric_ca_client.register({enrollmentID: userID, affiliation: 'org1.department1'}, admin_user);
}).then((secret) => {
